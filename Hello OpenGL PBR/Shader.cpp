...
void Shader::BindUniformBlockToIndex(std::string UniformName, GLuint Index)
{
	GLuint UniformBlockIndex = glGetUniformBlockIndex(ShaderProgramID, UniformName.c_str());
	glUniformBlockBinding(ShaderProgramID, UniformBlockIndex, Index);
}
